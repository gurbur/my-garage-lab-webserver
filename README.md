...
[My Garage Lab SSG](https://github.com/gurbur/my-garage-lab-ssg) 프로젝트의 결과물을 배포하기 위해 C언어로 처음부터 직접 개발한 **고성능 비동기 멀티스레드 웹 서버**입니다. 이 프로젝트는 시스템 프로그래밍과 네트워크 프로그래밍의 핵심 개념을 실제 프로젝트에 적용하며 깊이 있게 이해하는 것을 목표로 합니다.
